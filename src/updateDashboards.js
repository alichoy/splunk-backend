...
exports.handler = async (event) => {
    const { dashboard_id } = event.pathParameters;
    ...
    const updateQuery = `UPDATE dashboards SET ${updateFields.join(', ')} WHERE dashboard_id = ?`;
    const updateParams = [...updateValues, dashboard_id];
